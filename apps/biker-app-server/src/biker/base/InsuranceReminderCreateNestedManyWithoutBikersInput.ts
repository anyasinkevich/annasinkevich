...
@InputType()
class InsuranceReminderCreateNestedManyWithoutBikersInput {
...
export { InsuranceReminderCreateNestedManyWithoutBikersInput as InsuranceReminderCreateNestedManyWithoutBikersInput };
