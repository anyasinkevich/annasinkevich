...
@InputType()
class InsuranceReminderUpdateInput {
  @ApiProperty({
    required: false,
  })
  @IsDate()
  ...
  @ApiProperty({
    required: false,
    type: () => BikerUpdateManyWithoutInsuranceRemindersInput,
  })
  @ValidateNested()
  @Type(() => BikerUpdateManyWithoutInsuranceRemindersInput)
  @IsOptional()
  @Field(() => BikerUpdateManyWithoutInsuranceRemindersInput, {
    nullable: true,
  })
...
export { InsuranceReminderUpdateInput as InsuranceReminderUpdateInput };
